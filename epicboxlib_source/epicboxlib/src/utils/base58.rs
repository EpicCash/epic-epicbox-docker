...
pub trait FromBase58 {
    ...
    fn from_base58(&self) -> ResultSingle<Vec<u8>>;
    fn from_base58_check(&self, version_bytes: usize) -> ResultSingle<(Vec<u8>, Vec<u8>)>;
}
    ...
    fn from_base58(&self) -> ResultSingle<Vec<u8>> {
        ...
        while i < self.len() {
            if (b58[i] & 0x80) != 0 {
                ...
                Err(Error::InvalidBase58Character(b58[i] as char, i))?;
            }
